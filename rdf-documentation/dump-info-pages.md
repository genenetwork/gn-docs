...
gn:Infofiles_infopagename_ -> gdmt:hasCreatorAffiliation -> Organizations 
...
gn:Infofiles_infopagename_ -> gnt:usedNormalization -> gn:avgmethod_avgmethod_avgmethodname 
gn:Infofiles_infopagename_ -> gnt:usedPlatform -> gn:platform_genechip_genechip 
...
gn:Infofiles_infopagename_ -> gnt:hasCaseInfo -> AboutCases 
gn:Infofiles_infopagename_ -> gnt:hasPlatformInfo -> AboutPlatform 
gn:Infofiles_infopagename_ -> gnt:hasDataProcessingInfo -> AboutDataProcessing 
gn:Infofiles_infopagename_ -> gnt:hasNotes -> GNNotes 
gn:Infofiles_infopagename_ -> gnt:hasExperimentDesignInfo -> ExperimentDesign 
gn:Infofiles_infopagename_ -> gdmt:hasContributorInfo -> Contributors 
gn:Infofiles_infopagename_ -> gdmt:IsCitedBy -> Citation 
gn:Infofiles_infopagename_ -> gnt:hasAcknowledgement -> Data_Source_Acknowledge 
...
```rdf
gn:Br_u_0803_m rdf:type gnc:dataset .
...
gn:Br_u_0803_m gnt:usedNormalization gn:avgmethod_mas5 .
gn:Br_u_0803_m gnt:usedPlatform gn:platform_mg_u74av2 .
